...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Formulir Edit Quiz</h5>
                    ...
                    <form action="{{ route('quizzes.update', $quiz->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('modul_id') is-invalid @enderror" name="modul_id"
                                    id="modul_id" required>
                                    <option value="">-- Pilih Modul --</option>
                                    @foreach ($moduls as $modul)
                                        <option value="{{ $modul->id }}"
                                            {{ old('modul_id', $quiz->modul_id) == $modul->id ? 'selected' : '' }}>
                                            {{ $modul->nama_modul }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('judul_quiz') is-invalid @enderror"
                                    id="judul_quiz" name="judul_quiz" value="{{ old('judul_quiz', $quiz->judul_quiz) }}"
                                    required>
                                @error('judul_quiz')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $quiz->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control @error('durasi_menit') is-invalid @enderror"
                                    ...
                                    value="{{ old('durasi_menit', $quiz->durasi_menit) }}" min="1">
                                @error('durasi_menit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01"
                                    ...
                                    name="bobot_nilai" value="{{ old('bobot_nilai', $quiz->bobot_nilai) }}" min="0.01"
                                    max="100">
                                @error('bobot_nilai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control @error('passing_grade') is-invalid @enderror"
                                    ...
                                    value="{{ old('passing_grade', $quiz->passing_grade) }}" min="1" max="100">
                                @error('passing_grade')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control @error('jumlah_soal') is-invalid @enderror"
                                    id="jumlah_soal" name="jumlah_soal"
                                    value="{{ old('jumlah_soal', $quiz->jumlah_soal) }}" min="0">
                                @error('jumlah_soal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control @error('max_attempt') is-invalid @enderror"
                                    ...
                                    value="{{ old('max_attempt', $quiz->max_attempt) }}" min="0">
                                @error('max_attempt')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" id="random_soal" name="random_soal"
                                        {{ old('random_soal', $quiz->random_soal) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" id="tampilkan_hasil"
                                        ...
                                        {{ old('tampilkan_hasil', $quiz->tampilkan_hasil) ? 'checked' : '' }}>
