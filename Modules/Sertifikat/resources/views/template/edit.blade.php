...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Form Edit Template Sertifikat</h5>
                    ...
                    <form action="{{ route('template.sertifikat.update', $template->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('background')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Format gambar: JPG, PNG, GIF. Maksimal 2MB. Kosongkan jika tidak
                                        ingin mengubah.</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('design_template') is-invalid @enderror" id="design_template"
                                        name="design_template" rows="10">{{ old('design_template', $template->design_template) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('signature_config') is-invalid @enderror" id="signature_config"
                                        name="signature_config" rows="5">{{ old('signature_config', $template->signature_config) }}</textarea>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if ($template->logo_bpsdm_path)
                                                <div class="mb-2">
                                                    <img src="{{ Storage::url($template->logo_bpsdm_path) }}"
                                                        alt="Logo BPSDM" class="img-thumbnail" style="max-height: 100px;">
                                                </div>
                                            @endif
                                            <input type="file"
                                            ...
                                            @error('logo_bpsdm')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="form-text">Format: JPG, PNG. Maksimal 2MB. Kosongkan jika tidak
                                                ingin mengubah.</div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if ($template->logo_pemda_path)
                                                <div class="mb-2">
                                                    <img src="{{ Storage::url($template->logo_pemda_path) }}"
                                                        alt="Logo Pemda" class="img-thumbnail" style="max-height: 100px;">
                                                </div>
                                            @endif
                                            <input type="file"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h6 class="card-title">Informasi Template</h6>
