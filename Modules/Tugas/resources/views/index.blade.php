                            ...
                            <tbody>
                                @forelse($tugas as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->judul }}</td>
                                        <td>{{ $item->tanggal_mulai ? \Carbon\Carbon::parse($item->tanggal_mulai)->format('d M Y') : '-' }}
                                        </td>
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('tugas.show', $item->id) }}">
                                                            <i class="bi bi-eye"></i> Detail
                                                        </a></li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('tugas.submission', $item->id) }}">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('tugas.toggle-publish', $item->id) }}"
