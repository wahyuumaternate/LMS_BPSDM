            ...
            <form class="row g-3" action={{ route('course.store') }} method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <div class="">
                        <textarea class="form-control @error('tujuan_pembelajaran') is-invalid @enderror" id="tujuan_pembelajaran"
                            name="tujuan_pembelajaran" rows="3">{{ old('tujuan_pembelajaran') }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="">
                        <textarea class="form-control @error('sasaran_peserta') is-invalid @enderror" id="sasaran_peserta"
                            name="sasaran_peserta" rows="3">{{ old('sasaran_peserta') }}</textarea>
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_mulai_kursus') is-invalid @enderror"
                        id="tanggal_mulai_kursus" name="tanggal_mulai_kursus" value="{{ old('tanggal_mulai_kursus') }}">
