                    ...
                    <form action="{{ route('soal-ujian.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('pilihan_a') is-invalid @enderror" id="pilihan_a" name="pilihan_a" rows="2"
                                    required>{{ old('pilihan_a') }}</textarea>
                                @error('pilihan_a')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('pilihan_b') is-invalid @enderror" id="pilihan_b" name="pilihan_b" rows="2"
                                    required>{{ old('pilihan_b') }}</textarea>
                                @error('pilihan_b')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('pilihan_c') is-invalid @enderror" id="pilihan_c" name="pilihan_c" rows="2"
                                    required>{{ old('pilihan_c') }}</textarea>
                                @error('pilihan_c')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('pilihan_d') is-invalid @enderror" id="pilihan_d" name="pilihan_d" rows="2"
                                    required>{{ old('pilihan_d') }}</textarea>
                                @error('pilihan_d')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-10 offset-sm-2">
                                ...
                                {{-- <a href="{{ route('soal-ujian.by-ujian', ['ujian_id' => $ujian->id]) }}"
